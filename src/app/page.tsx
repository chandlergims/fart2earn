...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#363636] text-white">
      {/* Add floating hearts that follow cursor */}
      <div className="fixed inset-0 pointer-events-none select-none">
        <div className="absolute text-[#e7d61b] opacity-20 text-xs animate-float1" style={{top: '10%', left: '5%'}}>❤️</div>
        <div className="absolute text-[#e7d61b] opacity-20 text-xs animate-float2" style={{top: '30%', right: '15%'}}>❤️</div>
        <div className="absolute text-[#e7d61b] opacity-20 text-xs animate-float3" style={{bottom: '20%', left: '25%'}}>❤️</div>
      </div>

      {/* Add subtle corner message */}
      <div className="fixed bottom-2 right-2 text-[8px] text-gray-600 opacity-30 hover:opacity-100 transition-opacity duration-300">
        {getRandomMessage()}
      </div>

      {/* Add message in loading states */}
      ...
      {/* Add floating love message that follows scroll */}
      <div className="fixed top-1/2 right-4 transform -translate-y-1/2 text-xs text-[#e7d61b] opacity-30 hover:opacity-100 transition-opacity duration-300 writing-vertical">
        {getRandomMessage()}
      </div>
    </main>
  );
